...
const GenerateProgramPage = () => {
  ...
  // SOLUTION to get rid of "Meeting has ended" and "send transport changed to disconnected" errors
  useEffect(() => {
    const originalError = console.error;
    // override console.error to ignore known Vapi errors
    console.error = function (msg, ...args) {
      const errorMessage = msg?.toString() || "";
      const argsMessage = args[0]?.toString() || "";
      const combinedMessage = errorMessage + " " + argsMessage;

      if (
        combinedMessage.includes("Meeting has ended") ||
        combinedMessage.includes("send transport changed to disconnected")
      ) {
        // Silently ignore these known Vapi connection errors
